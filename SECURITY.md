...
Only the latest release in the `1.1.x` series receives security fixes.
...
- The django-icv-search version you tested against.
...
django-icv-search follows **coordinated disclosure** with a **90-day embargo**
period:
